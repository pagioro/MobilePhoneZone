...
class Category(models.Model):
    ...
    class Meta:
        ...
        name = models.CharField(max_length=254) # brand 
...
class Product(models.Model):
    category = models.ForeignKey('Category', null=True, blank=True, on_delete=models.SET_NULL) # brand  
    sku = models.CharField(max_length=254, null=True, blank=True)
    name = models.CharField(max_length=254)
    colour = models.CharField(max_length=254, null=True, blank=True)
    has_sizes = models.BooleanField(default=True, null=True, blank=True) # storage_size
